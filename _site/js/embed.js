!function (e, t, s) {
    ...
    if (o.extend = function (e, t) {
        ...
        var M = {
            ...
            newhua: "706ba4eb",
            justflat: "9d72ec5a"
        }, U = {"embed.compat": "24f8ca3f", smilies: "921e8eda"}, z = {
            post: "发布",
            posting: "正在发布",
            settings: "设置",
            reply: "回复",
            ...
            if (t.visitor && (!nt.data && t.visitor.user_id && e.Notification && A.send({logged_user_id: t.visitor.user_id}), nt.reset(t.visitor)), t.site && (rt.reset(t.site), D.save("ds_site_" + c.short_name, t.site)), !S.theme && rt.data.theme && n(rt.data.theme), t.lang && (o.extend(z, t.lang), D.save("ds_lang_" + c.short_name, t.lang)), t.stylesheets)for (var s = 0; s < t.stylesheets.length; s++)o.injectStylesheet(t.stylesheets[s]);
        ...
        et.commentList = function (e) {
            ...
            if (s)for (var a, i = -1, r = s.length - 1; r > i;)a = s[i += 1], t += '<a class="ds-' + a + '" href="' + Z.loginUrl(a) + '">' + S.sourceName[a] + "</a>";
            ...
            var t = '<h2>转发到微博</h2><div class="ds-quote"><strong>@' + u(e.post.theAuthor.name) + "</strong>: " + e.post.message + "</div><form>" + tt({post_id: e.post.post_id}) + '<div class="ds-textarea-wrapper"><textarea name="message" title="Ctrl+Enter快捷提交" placeholder="' + u(z.repost_reason) + '">' + u(e.repostMessage) + '</textarea><pre class="ds-hidden-text"></pre>';
            return t += '</div><div class="ds-actions">', e.service ? t += tt({"service[]": e.service}) : (t += '<label><input type="checkbox" name="service[]" value="weibo"', nt.data.social_uid.weibo && (t += ' checked="checked"'), t += ' /><span class="ds-service-icon ds-weibo"></span>新浪微博</label><label><input type="checkbox" name="service[]" value="qqt"', nt.data.social_uid.qq && (t += ' checked="checked"'), t += ' /><span class="ds-service-icon ds-qqt"></span>腾讯微博</label>'), t += '<button type="submit">' + z.repost + "</button></div></form>"
            ...
            var t = '<div class="ds-header ds-gradient-bg">' + u(z.hot_posts_title) + "</div><ul>", s = e.list;
            ...
            var t = '<div class="ds-icons-32">', s = e;
            if (s)for (var a, i = -1, r = s.length - 1; r > i;)a = s[i += 1], t += '<a class="ds-' + a + '" href="' + Z.loginUrl(a) + '">' + S.sourceName[a] + "</a>";
            return t += "</div>"
        }, et.meta = function (e) {
            ...
            if (t += '<li class="ds-post" data-post-id="' + s.post_id + '"><div class="ds-post-self" data-post-id="' + s.post_id + '" data-thread-id="' + s.thread_id + '" data-root-id="' + s.root_id + '" data-source="' + s.source + '"><div class="ds-avatar"', r.user_id && (t += ' data-user-id="' + r.user_id + '"'), t += ">" + et.avatar(r), S.sourceName[s.source] && (t += et.serviceIcon(s.source)), t += '</div><div class="ds-comment-body"><div class="ds-comment-header">', r.url ? (t += '<a class="ds-user-name ds-highlight" data-qqt-account="' + (r.qqt_account || "") + '" href="' + u(r.url) + '" ', r.user_id && (t += " onclick=\"this.href='" + a() + "/user-url/?user_id=" + r.user_id + "';\""), t += ' rel="nofollow" target="_blank"', r.user_id && (t += ' data-user-id="' + r.user_id + '"'), t += ">" + u(r.name) + "</a>") : (t += '<span class="ds-user-name"', r.user_id && (t += ' data-user-id="' + r.user_id + '"'), t += ' data-qqt-account="' + (r.qqt_account || "") + '">' + u(r.name) + "</span>"), t += "</div>", 1 == i.max_depth && i.show_context && s.parents.length) {
                ...
                if (n)for (var o, d = -1, l = n.length - 1; l > d;)o = n[d += 1], 1 == d && s.parents.length > 2 && (t += '<li class="ds-ctx-entry"><a href="javascript:void(0);" class="ds-expand">还有' + (s.parents.length - 2) + "条评论</a></li>"), t += et.ctxPost({
                    post: o,
                    index: d,
            ...
            var t = "", s = e.response;
            if (s)for (var a, i = -1, r = s.length - 1; r > i;)a = s[i += 1], t += '<div class="ds-avatar">' + et.avatar(a, e.options.avatar_size) + "</div>";
            return t
            ...
            if (e && e.length) {
                ...
                var s = e;
                if (s)for (var a, i = -1, r = s.length - 1; r > i;) {
                    if (a = s[i += 1], t += ' <a href="' + a.url + '" class="ds-reads-item"> ', 3 == a.imgs.length) {
                        t += " <h2>" + a.title + '</h2> <div class="ds-reads-pics"> <ul> ';
                        var n = a.imgs;
                        if (n)for (var o, d = -1, l = n.length - 1; l > d;)o = n[d += 1], t += ' <li> <div class="ds-reads-dumb"></div> <div class="ds-reads-pic-wrap" style="background-image:url(' + o + ');"></div> </li> ';
            ...
            var t = "", s = e;
            if (s)for (var a, i = -1, r = s.length - 1; r > i;)a = s[i += 1], t += '<li><a href="' + Z.bindUrl(a) + '" rel="nofollow" class="ds-service-link ds-' + a + '">' + S.serviceNames[a], nt.data.social_uid[a] && (t += ' <span class="ds-icon ds-icon-ok"></span>'), t += "</a></li>";
            return t
            ...
            var t = "", s = e.response;
            if (s)for (var a, i = -1, r = s.length - 1; r > i;)a = s[i += 1], t += '<li><a target="_blank" href="' + u(a.url) + '" title="' + u(a.title) + '">' + u(a.title) + "</a></li>";
            return t
        }, et.topUsers = function (e) {
            var t = "", s = e.response;
            if (s)for (var a, i = -1, r = s.length - 1; r > i;)a = s[i += 1], t += '<div class="ds-avatar">' + et.avatar(a, e.options.avatar_size) + "<h4>" + u(a.name) + "</h4></div>";
            return t
        ...
        it.on("queryDefined", function () {
            ...
            function x(e, t, s, a) {
                function i() {
                    function e(e) {
                        if (s && a) {
                            var t = s.options, i = M(s.postList.el, e.response[a], t);
                ...
                var t = {
                    "unread-comments": {
                        title: "新留言及回复", apiUrl: "users/unreadComments", tmpl: function (e) {
                            ...
                            R.post("threads/read", {thread_id: t}), ot.data.comments--
                        }
                        ...
                        title: "系统消息", apiUrl: "users/unreadNotifications", tmpl: function (e) {
                            ...
                            R.post("notifications/read", {notification_id: t}), ot.data.notifications--
                        }
                    }
                }[e], s = E("<h2>" + t.title + '</h2><ul class="ds-unread-list"></ul>');
            ...
            function U(e, t) {
                ...
                function a() {
                    var e = H(this).closest(".ds-post-self"), t = lt[e.attr("data-post-id")];
                    return x(t, ""), !1
                }
                ...
                function i() {
                    ...
                    return R.post("posts/remove", {post_id: t.attr("data-post-id")}), t.parent().fadeOut(200, function () {
                ...
                function n() {
                    ...
                    return R.post("posts/report", {post_id: e.attr("data-post-id")}), alert("感谢您的反馈！"), !1
                }
                ...
                function d() {
                    ...
                    {
                        var s = H(this).closest(".ds-post-self"), a = s.attr("data-post-id");
                        s.data("source")
                    }
                    if (0 != s.attr("data-root-id"))return !1;
                    var i = s.siblings(".ds-children");
                    return i[0] ? (i.remove(), !1) : (i = H('<ul class="ds-children"></ul>').insertAfter(s), R.get("posts/listComments", B({post_id: a}), e), !1)
                }

                function l() {
                    var t = H(this).closest(".ds-post-self"), s = lt[t.attr("data-post-id")], a = s.data.source;
            ...
            e.postMessage && (e.addEventListener ? e.addEventListener("message", g, !1) : e.attachEvent && e.attachEvent("onmessage", g)), S.scrollTo = function (e) {
                ...
                render: function (e) {
                    ...
                    var q = function (e) {
                        s(b), R.post("posts/create", H.extend(S.toJSON(b), e), function (e) {
                            var t = lt[e.response.post_id] = new F(e.response), s = M(i.postList, t, c);
                ...
                init: function (e, t) {
                    (this.el = H("#ds-wrapper"))[0] || (this.el = p(H('<div id="ds-wrapper"></div>'))), this.options = H.extend({width: 600}, t), e !== s && H(e).attr("id", "ds-reset").appendTo(this.el)
                }, open: function () {
                    function e(e) {
                ...
                render: function () {
                    ...
                    var s = this.embedThread, a = s.postList, i = this.el = H(et.postListHead({
                ...
                e = e || {};
                var s = this, a = s.el = e.el || H('<div class="ds-paginator"></div>'), i = s.collection = e.collection;
                ...
                render: function () {
                    ...
                    var s = this, a = s.el = H(et.smiliesTooltip(L));
            ...
            X.mouseenter(N).mouseleave(I), st.PostList = function (e) {
                ...
                url: "threads/listPosts", render: function () {
                    ...
                    var s = this, a = H(et.indicator()).appendTo(t.body).fadeIn(200);
                ...
                _init: function () {
                    ...
                    var a = "//s0.pstatp.com/site/reads-sdk/5bf3702b38076207bee1.js", i = t.createElement("script");
                ...
                onload: function (t) {
                    ...
                    }), H('<div id="MZADX_' + o.mzadx_id + '" style="margin:0 auto;"></div>').appendTo(d), __mz_rpq = e.__mz_rpq || [], __mz_rpq.push({
                        l: [o.mzadx_id],
                        r: "1",
                        _srv: "MZADX",
                        _callback: function () {
                        }
                    })), S.thread = a, ot.data !== s && ot.trigger("reset"), r() || A.send({visit_thread_id: a.threadId})
                },
            ...
            S.initSelector = function (e, t) {
                ...
                }), a.length && R.get("threads/counts", B({threads: a.join(",")}), s)
            }, (S.initView = function () {
